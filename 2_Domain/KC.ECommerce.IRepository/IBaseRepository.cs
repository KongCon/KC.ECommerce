...
namespace KC.ECommerce.IRepository
{
        ...
        where T : class
    {
        ...
        /// <returns></returns>
        IList<T> GetPageList(out int totalCount, int page, int pageSize);
        ...
        /// <param name="filter">过滤条件</param>
        /// <returns></returns>
        IList<T> GetPageList(out int totalCount, int page, int pageSize, Expression<Func<T, bool>> filter);
        ...
        /// <param name="orderBy">排序条件</param>
        /// <returns></returns>
        IList<T> GetPageList(out int totalCount, int page, int pageSize, Expression<Func<T, bool>> filter, Expression<Func<T, object>> orderBy);
        ...
        /// <param name="isAsc">是否升序，默认为true</param>
        /// <returns></returns>
        IList<T> GetPageList(out int totalCount, int page, int pageSize, Expression<Func<T, bool>> filter, Expression<Func<T, object>> orderBy, bool isAsc);
        ...
        /// <param name="includeList">关联实体</param>
        /// <returns></returns>
        IList<T> GetPageList(out int totalCount, int page, int pageSize, Expression<Func<T, bool>> filter, Expression<Func<T, object>> orderBy, bool isAsc, IEnumerable<string> includeList);
    }
}
